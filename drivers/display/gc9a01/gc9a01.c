#define DT_DRV_COMPAT seeedrounddisplay_gc9a01
...
static const uint8_t initcmd[] = {
    ...
    0x8F, 1, 0xFF,
    0xB6, 2, 0x00, 0x00,
#if DT_PROP(DT_INST(0, seeedrounddisplay_gc9a01), rotation) == 0
    GC9A01A_MADCTL, 1,  MADCTL_MV | MADCTL_MY | MADCTL_MX | MADCTL_BGR,
#elif DT_PROP(DT_INST(0, seeedrounddisplay_gc9a01), rotation) == 90
    GC9A01A_MADCTL, 1,  MADCTL_MH | MADCTL_MY | 0 | MADCTL_BGR,
#elif DT_PROP(DT_INST(0, seeedrounddisplay_gc9a01), rotation) == 180
    GC9A01A_MADCTL, 1,  MADCTL_MV | 0 | 0 | MADCTL_BGR,
#elif DT_PROP(DT_INST(0, seeedrounddisplay_gc9a01), rotation) == 270
